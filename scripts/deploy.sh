...
# 실행 중인 도커 컴포즈 확인
EXIST_A=$(sudo docker-compose -p springboot-a -f /home/ec2-user/miniBacktesting_be/docker-compose.a.yml ps | grep Up)
...
sudo docker-compose -p springboot-${START_CONTAINER} -f /home/ec2-user/miniBacktesting_be/docker-compose.${START_CONTAINER}.yml up -d --build
...
sudo docker-compose -p springboot-${TERMINATE_CONTAINER} -f /home/ec2-user/miniBacktesting_be/docker-compose.${TERMINATE_CONTAINER}.yml down
